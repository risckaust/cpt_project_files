function dadt = cpt_carrymode(t,a,ki,kp,kd,T_switch,A_des,v_max,T,cable_len,L,radial_os,mass,Iz)
...
dadt(4) = a(5);%x2 
dadt(5) = a(6);%x2'
dadt(6) = cpt_sat_o(a(4),a(5),a(6),t,v_max(3),ki(3),kp(3),kd(3),a(1),a(2),a(3),cable_len,L);%x2''
dadt(7) = a(8);%xc
dadt(8) = a(9);%xc'
